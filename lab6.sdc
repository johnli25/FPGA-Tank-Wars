...
# SDRAM CLK
create_generated_clock -source [get_pins { create_generated_clock -source [get_pins {m_lab61_soc|sdram_pll|sd1|pll7|clk[1]}]  }] \
...
set_multicycle_path -from [get_clocks {clk_dram_ext}] \
                    -to [get_clocks { create_generated_clock -source [get_pins {m_lab61_soc|sdram_pll|sd1|pll7|clk[0]}]  }] \
						  -setup 2
...
set_false_path -from * -to [get_ports {DRAM*}]
